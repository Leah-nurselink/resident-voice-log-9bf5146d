...
export const careNotes: CareNote[] = [
  ...
  },
  {
    ...
    residentId: "r-002",
    category: "Mobility",
    transcript: "John seemed unsteady when walking to the bathroom, used frame and one staff assisting.",
    note: "John appeared unsteady whilst mobilising to the bathroom. Walking frame in use with one staff assisting. No fall sustained.",
    author: "Aisha Khan (Care Assistant)",
  ...
  },
  {
    ...
    residentId: "r-002",
    category: "Mobility",
    transcript: "John lost his balance briefly when standing from the armchair but staff supported him.",
    note: "John briefly lost balance when standing from the armchair. Staff intervened and supported him. No injury.",
    author: "Marcus Bell (Senior Carer)",
